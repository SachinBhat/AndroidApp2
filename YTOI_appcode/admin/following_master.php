...
<div id="dialog" title="Following Master">
</div>
<div class="MiddleArea align">
  <div class="content-box">
    <div class="content-header-left"></div>
    <div class="content-header-midd"> <span>Following  Master</span>
      <ul class="content-box-tabs">
        <li><span class="current"><a href="home.php?p=17" title="View Records">View</a></span></li>
        <!--<li><span><a href="<?php echo $default_url."p=18" ?>" title="Add New Record">Add</a></span></li> -->
      </ul>
    </div>
 ...
 <table>
	...
	<?php if($_REQUEST['msg']=='add') { ?>
                ...
                <center><div id="err" class="err"><span style="text-align:center;">Following has been added successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='update') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Following has been updated successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='delete') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Following has been deleted successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='active') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Following has been activated successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='deactive') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Following has been deactivated successfully !!</span></div></center>
    ...
    <div id="ajax_content"> 
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Listing">
		...
		if($_REQUEST['id']!='')
		{
				$where.="f.follower_id='".$_REQUEST['id']."' AND ";
		}
        ...
        <tfoot>
          <tr align="right">
            ...
            <?php
			  ...
			  $query=$dx[0];
			  $path=$default_url."p=17&id=".$_GET['id'];
			  $path.="&";
