...
$(function() {
  ...
  $('#chk_checkall').click(function() {
	...
	$('.dialog_link').click(function(){
					...
					$('#dialog').load("iteam_view.php?id="+val);
					return false;
	});
...
<div id="dialog" title="Iteam Master">
</div>
<div class="MiddleArea align">
  <div class="content-box">
    ...
    <div class="content-header-midd"> <span>Iteam  Master</span>
      <ul class="content-box-tabs">
        <li><span class="current"><a href="home.php?p=8" title="View Records">View</a></span></li>
        <li><span><a href="<?php echo $default_url."p=9" ?>" title="Add New Record">Add</a></span></li>
      </ul>
    </div>
  ...
  <tr>
    <td width="40%" align="right" valign="middle">Iteam Title:</td>
 ...
 <table>
	...
	<?php if($_REQUEST['msg']=='add') { ?>
                ...
                <center><div id="err" class="err"><span style="text-align:center;">Iteam information has been added successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='update') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Iteam information has been updated successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='delete') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Iteam  has been deleted successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='active') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Iteam has been activated successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='deactive') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Iteam has been deactivated successfully !!</span></div></center>
    ...
    <div id="ajax_content"> 
      <form method="post" name="frm_club" id="frm_club" action="<?php echo URL; ?>iteam_delete_process.php">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Listing">
		...
		$where.="iteam_id!='' ORDER BY iteam_id ASC LIMIT $startpoint,$perpage";
		...
		if($rows>=1)
		{
		 ...
		 ?>
          <tr class="<?php echo $tr_cls; ?>">
            <td align="center" valign="middle"><input class="check-all" type="checkbox" name="chk[]" id="chk_all" value="<?php echo $val["iteam_id"]; ?>" />
			</td>
			
            <td align="left" valign="middle"><a href="#" class="dialog_link" title="View Record" id="<?php echo $val['iteam_id']; ?>"><?php echo $val['title']; ?></a>
			</td>
            ...
            <td align="center" valign="middle"><a href="home.php?p=9&id=<?php echo $val["iteam_id"]; ?>&action=edit" title="Edit Record"><img src="images/edit.png" width="16" height="16" border="0" /></a>&nbsp;&nbsp;<a href="#" class="dialog_link" title="View Record" id="<?php echo $val['iteam_id']; ?>"><img src="images/search.png" width="16" height="16" border="0" />
			</a>
			</td>
