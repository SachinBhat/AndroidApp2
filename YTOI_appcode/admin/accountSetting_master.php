...
$(function() {
  ...
  $('#chk_checkall').click(function() {
	...
	$('.dialog_link').click(function(){
					...
					$('#dialog').load("accountSetting_view.php?id="+val);
					return false;
	});
...
<div id="dialog" title="accountSetting Master">
</div>
<div class="MiddleArea align">
  <div class="content-box">
    <div class="content-header-left"></div>
    <div class="content-header-midd"> <span>accountSetting  Master</span>
      <ul class="content-box-tabs">
        <li><span class="current"><a href="home.php?p=27" title="View Records">View</a></span></li>
        <!--<li><span><a href="<?php echo $default_url."p=28" ?>" title="Add New Record">Add</a></span></li> -->
      </ul>
    </div>
 ...
 <table>
	...
	<?php if($_REQUEST['msg']=='add') { ?>
                ...
                <center><div id="err" class="err"><span style="text-align:center;">Account information has been added successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='update') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Account information has been updated successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='delete') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Account information has been deleted successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='active') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Account information has been activated successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='deactive') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">account information has been deactivated successfully !!</span></div></center>
    ...
    <div id="ajax_content"> 
      <form method="post" name="frm_club" id="frm_club" action="<?php echo URL; ?>accountSetting_delete_process.php">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Listing">
        <thead>
          <tr>
			...
			<th align="left" valign="middle">About</th>
			<th align="left" valign="middle">Proxy</th>
		...
		if($rows>=1)
		{
		 ...
		 ?>
          <tr class="<?php echo $tr_cls; ?>">
            ...
            <td align="left" valign="middle"><?php echo $val['about']; ?>
			</td>
			
			<td align="left" valign="middle"><?php echo $val['proxy']; ?>
			</td>
