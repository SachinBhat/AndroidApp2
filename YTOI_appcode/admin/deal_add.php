...
<div class="MiddleArea align">
  <div class="content-box">
    ...
    <div class="content-header-midd"> <span>Deal Master</span>
      <ul class="content-box-tabs">
        <li><span><a href="<?php echo $default_url."p=6" ?>" title="View Records">View</a></span></li>
        <li><span class="current"><a href="<?php echo $default_url."p=7" ?>" title="Add New Record">Add</a></span></li>
      </ul>
    </div>
	...
	if($id!='')
	{
		$page="deal_process.php?e=1";
	}
	else
	{
		$page="deal_process.php";
	}
  ...
  <tr>
    <td width="200" align="right" valign="middle">Deal Title <p1 class="c">*</p1></td>
