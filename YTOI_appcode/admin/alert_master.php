...
$(function() {
  ...
  $('#chk_checkall').click(function() {
	...
	$('.dialog_link').click(function(){
					...
					$('#dialog').load("alert_view.php?id="+val);
					return false;
	});
...
<div id="dialog" title="alert Master">
</div>
<div class="MiddleArea align">
  <div class="content-box">
    <div class="content-header-left"></div>
    <div class="content-header-midd"> <span>Alert  Master</span>
      <ul class="content-box-tabs">
        <li><span class="current"><a href="home.php?p=21" title="View Records">View</a></span></li>
        <!--<li><span><a href="<?php echo $default_url."p=22" ?>" title="Add New Record">Add</a></span></li> -->
      </ul>
    </div>
 ...
 <table>
	...
	<?php if($_REQUEST['msg']=='add') { ?>
                ...
                <center><div id="err" class="err"><span style="text-align:center;">Message has been added successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='update') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Message has been updated successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='delete') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Message has been deleted successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='active') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Message has been activated successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='deactive') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Message has been deactivated successfully !!</span></div></center>
    ...
    <div id="ajax_content"> 
      <form method="post" name="frm_club" id="frm_club" action="<?php echo URL; ?>alert_delete_process.php">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Listing">
        <thead>
          <tr>
			...
			<th align="left" valign="middle">Alert Message</th>
		...
		if($rows>=1)
		{
		 ...
		 ?>
          <tr class="<?php echo $tr_cls; ?>">
			...
			<td align="left" valign="middle"><?php echo $val['alert_message']; ?>
			</td>
