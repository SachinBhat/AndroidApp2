...
<form action="#" method="post" name="my_form" id="my_form" enctype="multipart/form-data" >
  ...
  <tr>
    <td align="left" valign="middle" bgcolor="#CCCCCC" class="td_heading"><strong>Device Information </strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="200" align="right" valign="middle"> Registration Id  </td>
    <td width="10" align="center" valign="middle">:</td>
    <td align="left" valign="middle"><label for="registration_id"></label>
      <?php echo $result['registration_id']; ?></td>
  </tr>
  <tr>
