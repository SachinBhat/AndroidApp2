...
$(function() {
  ...
  $('#chk_checkall').click(function() {
	...
	$('.dialog_link').click(function(){
					...
					$('#dialog').load("meme_view.php?id="+val);
					return false;
	});
...
<div id="dialog" title="Meme Master">
</div>
<div class="MiddleArea align">
  <div class="content-box">
    ...
    <div class="content-header-midd"> <span>Meme  Master</span>
      <ul class="content-box-tabs">
        <li><span class="current"><a href="home.php?p=11" title="View Records">View</a></span></li>
        <li><span><a href="<?php echo $default_url."p=12" ?>" title="Add New Record">Add</a></span></li>
      </ul>
    </div>
  ...
  <tr>
    <td width="40%" align="right" valign="middle">Meme Title:</td>
 ...
 <table>
	...
	<?php if($_REQUEST['msg']=='add') { ?>
                ...
                <center><div id="err" class="err"><span style="text-align:center;">Meme information has been added successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='update') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Meme information has been updated successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='delete') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Meme  has been deleted successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='active') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Meme has been activated successfully !!</span></div></center>

    <?php } ?>
	<?php if($_REQUEST['msg']=='deactive') { ?>

                <center><div id="err" class="err"><span style="text-align:center;">Meme has been deactivated successfully !!</span></div></center>
    ...
    <div id="ajax_content"> 
      <form method="post" name="frm_club" id="frm_club" action="<?php echo URL; ?>meme_delete_process.php">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Listing">
		...
		$where.="meme_id!='' ORDER BY meme_id ASC LIMIT $startpoint,$perpage";
		...
		if($rows>=1)
		{
		 ...
		 ?>
          <tr class="<?php echo $tr_cls; ?>">
            <td align="center" valign="middle"><input class="check-all" type="checkbox" name="chk[]" id="chk_all" value="<?php echo $val["meme_id"]; ?>" />
			</td>
			
            <td align="left" valign="middle"><a href="#" class="dialog_link" title="View Record" id="<?php echo $val['meme_id']; ?>"><?php echo $val['title']; ?></a>
			</td>
            ...
            <td align="center" valign="middle"><a href="home.php?p=12&id=<?php echo $val["meme_id"]; ?>&action=edit" title="Edit Record"><img src="images/edit.png" width="16" height="16" border="0" /></a>&nbsp;&nbsp;<a href="#" class="dialog_link" title="View Record" id="<?php echo $val['meme_id']; ?>"><img src="images/search.png" width="16" height="16" border="0" />
			</a>
			</td>
